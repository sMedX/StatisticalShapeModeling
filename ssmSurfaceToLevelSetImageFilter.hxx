...
namespace ssm
{
  ...
  void SurfaceToLevelSetImageFilter<TInputMesh, TOutputImage>::GenerateData()
  {
    ...
    typedef itk::MinimumMaximumImageCalculator <BinaryImageType> MinimumMaximumImageCalculatorType;
    ...
    if (labelValues->GetMaximum() < surfaceToImage->GetInsideValue()) {
      itkExceptionMacro(<< "warning: there is no region of interest7 in image");
    }
